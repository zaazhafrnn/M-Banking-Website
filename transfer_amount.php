...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['amount'])) {
        ...
        echo "Error: 'amount' key is not set in POST data.";
    }
}
    ...
    <div class="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <div class="header mb-6">
        ...
        <div class="progress-bar mt-4">
          ...
          <div class="text-left text-sm text-gray-500 mt-1">Input Amount</div>
          <div class="text-right text-sm text-gray-500 mt-1">Step 3 of 5</div>
        </div>
      </div>
