        ...
        <div class="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <div class="header mb-6">
                ...
                <div class="progress-bar mt-4">
                    ...
                    <div class="text-left text-sm text-gray-500 mt-1">Select Bank and Input Account Number</div>
                    <div class="text-right text-sm text-gray-500 mt-1">Step 1 of 5</div>
                </div>
            </div>
